package com.github.dig.endervaults.nms.v1_18_R1;
...
@Log
public class v1_18_R1NMS implements VaultNMS {
    ...
    public Object[] decode(String encoded) throws IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
        ...
        Method nbtTagCompoundIsEmptyMethod = nbtTagCompoundClass.getMethod("f");
